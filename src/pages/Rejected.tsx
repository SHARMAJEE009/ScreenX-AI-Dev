...
export default function Rejected() {
  ...
  const loadCandidates = async () => {
    ...
    try {
      ...
      const result = await apiService.getRejectedCandidates(filters, 1, 100);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">View all rejected candidate applications</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        {loading ? (
          ...
          <EmptyState
            message="No rejected candidates"
            description="Candidates marked as rejected will appear here."
          />
        ) : (
