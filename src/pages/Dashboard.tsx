  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Welcome back! Here's what's happening with your candidates.</p>
      </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="text-left border-b border-gray-200">
                    ...
                    <th className="pb-3 text-sm font-semibold text-gray-700">Position</th>
                ...
                <tbody>
                  {recentCandidates.map(candidate => (
                    <tr key={candidate.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 text-sm text-gray-600">{candidate.Email}</td>
                      <td className="py-3 text-sm text-gray-600">{candidate.Position_Applied}</td>
                      <td className="py-3 text-sm text-gray-600">{candidate.Location}</td>
                      <td className="py-3">
